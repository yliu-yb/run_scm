...
if bkgrid_res == "27":
    wrf_3d_file = "/home/yl/wrf/wrfv4.4/WRF/run/wrfout_d01_2016-05-31_00:00:00"
elif bkgrid_res == "9":
    wrf_3d_file = "/home/yl/wrf/wrfv4.4/WRF/run/wrfout_d02_2016-05-31_00:00:00"
else:
    wrf_3d_file = "/home/yl/wrf/wrfv4.4/WRF/run/wrfout_d03_2016-05-31_00:00:00"
...
# case folder
scm_folder = "bkgrid_res_" + bkgrid_res + "_tau_" + tau_res +"_physicID_" + str(physicID) + "_tempdiff_" + temp_diff + "_"+str(start_year)+str(start_month)+str(start_day).zfill(2) + "_" + str(start_hour) + "0000-"+str(end_year)+str(end_month)+str(end_day).zfill(2) + "_" + str(end_hour)
...
if force_source_type == "ERA5":
    ...
    force.make(wrf_3d_file,
               ...
               bkgrid_res)
# make scm namelist
make_namelist.make(run_hours, start_year, start_month, start_day, start_hour, end_year, end_month, end_day, end_hour, bkgrid_res, physicID)
...
wrf_out = "../bktime_res" + bkgrid_res  + "_tau_" + tau_res + "_physicID_" + str(physicID)+ "_tempdiff_" + temp_diff + "_wrf_out"
